...
- Account takeover (RekeyTo): [yes/no — permanent until rekeyed back]
- Balance drain (Close): [yes/no — entire balance in one tx]
...
- [ ] ClaudeSkills pattern (A1–A9) reference included if applicable
...
4. **Clear state program ≠ reject.** The clear state program ALWAYS succeeds.
...
6. **Smart signatures need EVERYTHING.** They're stateless — they cannot rely
